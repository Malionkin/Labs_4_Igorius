...
INT_PTR CALLBACK    List_creator(HWND, UINT, WPARAM, LPARAM);
    ...
    case WM_COMMAND:
        {
            ...
            case ID_CHANGE_SIZE_MENU:
                DialogBox(hInst, MAKEINTRESOURCE(IDD_DIALOG1), hWnd, List_creator);
                break;
...
INT_PTR CALLBACK List_creator(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_COMMAND:
        ...
        case IDC_BUTTON_PLUS1: {
            WCHAR string_text[200];
            GetDlgItemText(hDlg, IDC_TEXT, string_text, 200);
            SendDlgItemMessage(hDlg, IDC_LIST, LB_ADDSTRING, NULL, (LPARAM)string_text);
            break;
        }
        ...
        case IDC_BUTTON_MINUS: {
            ...
            number_of_string = SendDlgItemMessage(hDlg, IDC_LIST, LB_GETCURSEL, NULL, NULL);
            SendDlgItemMessage(hDlg, IDC_LIST, LB_DELETESTRING, number_of_string, NULL);
            break;
        }
